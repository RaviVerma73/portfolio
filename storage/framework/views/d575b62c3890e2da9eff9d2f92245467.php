                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4 align-items-center">
                            ...
                            <form action="<?php echo e(route('work.add')); ?>" method="post" enctype="multipart/form-data">
                             <?php echo csrf_field(); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-floating mb-3 col-sm-6" style='margin-right: 4px;'>
                                    <input type="text" name="url" value="" class="form-control" id="Url"
                                        placeholder="Url">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel-Crud\project-rvi\resources\views/admin/work/add.blade.php ENDPATH**/ ?>