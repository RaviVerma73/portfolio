                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4 align-items-center">
                            ...
                            <form action="<?php echo e(route('blog.add')); ?>" method="post" enctype="multipart/form-data">
                             <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel-Crud\project-rvi\resources\views/admin/blog/add.blade.php ENDPATH**/ ?>