	...
	<div class="page new-skin">
		...
		<div class="container opened" data-animation-in="fadeInLeft" data-animation-out="fadeOutLeft">
			...
			<header class="header">
				...
				<!-- menu -->
                @include('portfolio.layout._sidebar')
                <!-- menu -->
			...
			<div class="card-inner" id="works-card">
				<div class="card-wrap">
					...
					<div class="content works">
						...
						@foreach ($data['work'] as $key_w => $val_w )
							<div class="col col-d-6 col-t-6 col-m-12 grid-item {{$type[$key_w]}} border-line-h">
								<div class="box-item">
									<div class="image">
										<a href="#popup-1" class="has-popup-media">
											<img src="{{asset('storage/work_img/'.$val_w->image)}}" alt="" />
											<span class="info">
									...
									<div class="desc">
										<a href="#popup-1" class="name has-popup-media">{{$val_w->title}}</a>
