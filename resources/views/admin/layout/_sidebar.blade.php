            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{ asset('storage/img/' . auth()->user()->image) }}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('work')}}" class="nav-item nav-link {{ request()->segment(1) == 'work' ? 'active':'' }}"><i class="fas fa-tasks me-2"></i>Works</a>
